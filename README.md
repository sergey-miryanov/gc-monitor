...
```bash
export GC_MONITOR_PYPERF_HOOK_OUTPUT="gc_monitor_{bench_name}.json"
export GC_MONITOR_PYPERF_HOOK_NORMALIZE_TS="1"
# Run benchmark with Chrome Trace output
python my_benchmark.py  --hook=gc_monitor --inherit-environ=GC_MONITOR_PYPERF_HOOK_OUTPUT,GC_MONITOR_PYPERF_HOOK_NORMALIZE_TS -p 5
